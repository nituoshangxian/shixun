<template>
  <el-dialog title="拍照上传" :visible.sync="visible" width="1065px">
    ...
    <div slot="footer" style="display:flex">
      ...
      <el-button v-if="os" @click="getCompetence" icon="el-icon-video-camera">打开摄像头</el-button>
      <el-button v-else @click="stopNavigator" icon="el-icon-switch-button">关闭摄像头</el-button>
      <el-button @click="resetCanvas" icon="el-icon-refresh">重置</el-button>
      <el-button @click="onCancel" icon="el-icon-circle-close">完成</el-button>
    </div>
  </el-dialog>
</template>
