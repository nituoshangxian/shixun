...
public class YishengzixunController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YishengzixunEntity yishengzixun, 
		HttpServletRequest request){
        EntityWrapper<YishengzixunEntity> ew = new EntityWrapper<YishengzixunEntity>();
     ...
     */
    @RequestMapping("/add")
    public R add(@RequestBody YishengzixunEntity yishengzixun, HttpServletRequest request){
    	//ValidatorUtils.validateEntity(yishengzixun);
        yishengzixunService.insert(yishengzixun);
        return R.ok();
    }
