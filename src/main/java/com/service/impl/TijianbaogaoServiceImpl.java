...
public class TijianbaogaoServiceImpl extends ServiceImpl<TijianbaogaoDao, TijianbaogaoEntity> implements TijianbaogaoService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<TijianbaogaoEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<TijianbaogaoEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<TijianbaogaoEntity> wrapper) {
