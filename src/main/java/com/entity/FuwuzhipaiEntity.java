...
public class FuwuzhipaiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FuwuzhipaiEntity() {
		
	}
	
	public FuwuzhipaiEntity(T t) {
		try {
	 ...
	 * 设置：服务备注
	 */
	public void setFuwubeizhu(String fuwubeizhu) {
		this.fuwubeizhu = fuwubeizhu;
	}
	/**
	 * 获取：服务备注
	 */
	public String getFuwubeizhu() {
		return fuwubeizhu;
	}
	/**
	 * 设置：医生工号
