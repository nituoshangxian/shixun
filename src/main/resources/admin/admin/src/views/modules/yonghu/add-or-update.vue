	...
	<div class="addEdit-block" :style='{"padding":"0 30px","margin":"0 auto","color":"#666","borderRadius":"4px","background":"none","width":"96%","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="密码错误次数" prop="passwordwrongnum">
					<el-input v-model.number="ruleForm.passwordwrongnum" placeholder="密码错误次数" clearable  :readonly="ro.passwordwrongnum"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="密码错误次数" prop="passwordwrongnum">
...
export default {
    ...
    onSubmit() {
      ...
      if(((this.ruleForm.yonghuzhanghao).toString().length>10)){
      ...
      if(((this.ruleForm.mima).toString().length>10)){
