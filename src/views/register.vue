	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(https://bpic.588ku.com/back_pic/05/98/70/025ef5c111a665e.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-start"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #eee","minHeight":"850px","padding":"30px 6%  40px","boxShadow":"0 0px 0px rgba(64, 158, 255, .6)","margin":"0 0 0 46%","borderRadius":"0px","textAlign":"center","background":"rgba(255,255,255,1)","width":"750px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"10px auto 20px","color":"rgba(55,55,55,1)","textAlign":"left","background":"none","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"30px","fontWeight":"500"}' class="title"> 智慧医养大数据公共服务平台医生服务系统注册</div>
