				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yonghu','体检报告')" @click="tijianbaogaoCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import tijianbaogaoCrossAddOrUpdate from "../tijianbaogao/add-or-update.vue";
	export default {
		data() {
			return {
				xingbieOptions: [],
